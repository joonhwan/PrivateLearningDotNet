...
test("primitive.is", function() {
  ...
  Enumerable.rangeTo(10, 15, 2).is(10, 12, 14);
  [1, 5, 10].all("$<12").isTrue();
});
...
test("function.is", function() {
  ...
  o.is(function(x) {
    return x.a == "a" && x.b == 100 && x.c == true;
  });
  "foobar".is(function(x) {
    return x.toUpperCase() == "FOOBAR";
  });
});
test("function.expression", function() {
  Math.abs(-100).is(function(x) {
    return x < 200;
  });
  Math.abs(-100).isExpr("$ < 200");
  Math.abs(-100).isNot(function(x) {
    return x !== 100;
  });
...
test("function.isNot", function() {
  ...
  o.isNot(function(x) {
    return x.a == "a" && x.b == 1300 && x.c == true;
  });
  "foobar".isNot(function(x) {
    return x.toUpperCase() == "FOoBAR";
  });
});
...
test("catch", function() {
  ...
  Enumerable.Assert.doesNotThrow(function() {}, "does not");
});
