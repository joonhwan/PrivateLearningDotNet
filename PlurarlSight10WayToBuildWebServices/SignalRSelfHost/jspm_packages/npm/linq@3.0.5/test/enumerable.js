...
test("repeatWithFinalize", function() {
  var fin;
  actual = Enumerable.repeatWithFinalize(function() {
    return "temp";
  }, function() {
    fin = "final";
  }).take(3).toArray();
...
test("generate", function() {
  actual = Enumerable.generate(function() {
    return "temp";
  }).take(3).toArray();
  deepEqual(actual, ["temp", "temp", "temp"]);
  actual = Enumerable.generate(function() {
...
test("defer", function() {
  var xs = [];
  var r = Enumerable.range(1, 5).doAction(function(x) {
    xs.push(x);
  });
  var de = Enumerable.defer(function() {
    return r;
  });
  xs.length.is(0);
