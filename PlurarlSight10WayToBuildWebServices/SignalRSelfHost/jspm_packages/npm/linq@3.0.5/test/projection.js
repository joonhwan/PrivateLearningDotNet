...
test("zip2", function() {
  [1, 2, 3].zip([-3, 4, 10], [5, 6, 7], function(x, y, z) {
    return x * y * z;
  }).is(-15, 48, 210);
  [1, 2, 3].zip([-3, 4, 10], [-3, 4, 10], function(x, y, z, i) {
    return i;
  }).is(0, 1, 2);
  [1, 2, 3].zip([-3, 4, 10], [-7, 20, 30, 100], function(x, y, z) {
    return x * y + z;
  }).is(-10, 28, 60);
  [1, 2, 3].zip([-3, 4, 10], [-7, 20, 30, 100], function(x, y, z, i) {
    return z + i;
  }).is(-7, 21, 32);
  Enumerable.from("abc").zip("fghk", "lmnopq", "stuv", "yz0124", "56780", function(a, b, c, d, e, f) {
    return a + b + c + d + e + f;
  }).is("aflsy5", "bgmtz6", "chnu07");
});
test("merge", function() {
  [1, 2, 3].merge([-3, 4, 10]).is(1, -3, 2, 4, 3, 10);
  [1, 2, 3].merge([-3, 4], [-7, 20, 30, 100]).is(1, -3, -7, 2, 4, 20, 3, 30, 100);
});
